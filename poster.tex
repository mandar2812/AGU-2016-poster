...
\begin{tikzpicture}[x=0.5\textwidth]
    ...
    {
        {\sffamily\veryHuge \textbf{Machine Learning for Space Weather}}\\
...
Using the solar wind speed as a predictive variable, we train a Gaussian Process model to predict the Dst index \ref{eq:DstGP}. We compare the  performance of the \textit{Radial Basis Function} (RBF) kernel versus the \textit{Fractional Brownian Motion} (FBM) kernel (eq. \ref{eq:rbfcov},\ref{eq:fbmcov}). 
\vspace{\baselineskip}

The figures below show the goodness of fit of the two GP models trained and tested for the years 2007 and 2006 respectively (Left: RBF kernel. Right: FBM kernel)

\vspace{\baselineskip}

\begin{tabular}{ll}
%\includegraphics[width=0.45\hsize]{rbf-hist}  &
\includegraphics[width=0.45\hsize]{rbf-fit}   &
%\includegraphics[width=0.45\hsize]{fbm-hist} & 
